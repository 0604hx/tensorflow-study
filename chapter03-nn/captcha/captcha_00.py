# encoding: utf-8
#
# 代码拷贝自 https://github.com/AIDeepLearning/CrackCaptcha/blob/master/main.py
#
...
def main():
    ...
    y = tf.layers.dropout(y, rate=keep_prob)
    y = tf.layers.dense(y, CAPTCHA_LENGTH * VOCAB_LENGTH)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_data', help='source size', default='./data/captcha_01.pkl')
    ...
    parser.add_argument('--checkpoint_dir', help='checkpoint dir', default='models/model.ckpt', type=str)
